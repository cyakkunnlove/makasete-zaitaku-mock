...
const faqs = [
  ...
  },
  {
    ...
    answer: 'はい。無菌調剤など通常の研修だけでは学びにくい内容も、動画講義や実地講義を組み合わせて習得できる体制を想定しています。',
  },
  {
  ...
  },
  {
    ...
    answer: '支援します。医療機関やケアマネとの関係づくり、紹介を受けた後の対応、対応状況の見える化まで、営業と運用をつなげて整理します。',
  },
  {
  ...
  },
  {
    ...
    answer: '夜間対応は日中の患者情報や申し送りが整っていることが前提です。まずは現状を確認し、必要な準備を整えてから接続します。',
  },
  {
    question: '料金はどのように決まりますか？',
    answer: '薬局数、在宅患者数、伴走範囲、教育範囲、夜間連携の有無によって調整します。料金ページの金額は提案用の目安です。',
  },
  {
