...
import { buildAdminBillingRecords, buildDayTaskCollectionRecords, type BillingCollectionRecord } from '@/lib/billing-read-model'
...
export async function POST(request: Request) {
  ...
  return NextResponse.json({ ok: true, adminBillingRecords, pharmacyName })
}
